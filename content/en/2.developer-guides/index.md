...
::card-group
::card{title="Authentication" icon="i-mdi-key" to="/developer-guides/authentication"}
Start here to learn how to securely authenticate your API requests.
::

::card{title="LiveChat" icon="i-mdi-forum" to="/developer-guides/livechat"}
Integrate real-time support and chat features into your application.
::
::card{title="Campaigns" icon="i-mdi-bullhorn" to="/developer-guides/campaigns"}
Orchestrate high-volume broadcasts and WhatsApp marketing flows.
::
::card{title="Leads" icon="i-mdi-account-group-round" to="/developer-guides/leads"}
Capture and manage leads from Facebook and TikTok Ads with automatic field mapping.
::

::card{title="Thirds" icon="i-mdi-account-group" to="/developer-guides/thirds"}
...
::
::card{title="Embedded Chat" icon="i-mdi-dock-window" to="/developer-guides/embedded/embedded_chat_docs"}
