...
description: Integrate directly with the Digishare LiveChat system via Webhooks and API.
...
::alert{type="info"}
Ensure you have your **Access Token** ready. See [Authentication](/how-to-use/authentication) for details.
::
...
To reply to a customer, make a `POST` request to the messages endpoint.
