...
::
::card{title="Message Templates" icon="i-lucide-file-text" to="/developer-guides/message-templates"}
Manage and send text or interactive message templates across channels.
::
