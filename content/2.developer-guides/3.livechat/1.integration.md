...
To reply to a customer, make a `POST` request to the messages endpoint. For a detailed reference on sending various message types (text, location, interactive), see [Outgoing Messages](/developer-guides/message-templates/outgoing-messages).
