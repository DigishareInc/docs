...
::api-playground{method="POST" url="https://api.digishare.ma/v1/messagesTemplates" description="Upload a file (PDF, image) to get a media_id for use in tickets." :variables='{"token": "YOUR_TOKEN"}' :headers='{"Authorization": "Bearer {token}", "Content-Type": "application/json"}' :body='{"type": "file", "category": "document", "file": {"base64": "data:application/pdf;base64,JVBERi0xLjQKJ...", "file_name": "invoice", "mime_type": "application/pdf"}}'}
::
